...
public class StoryPartController {
    ...
    public List<StoryPart> getAllStoryParts() {return storyPartsService.getAllStoryParts();}

    @GetMapping(value = "api/storypart/{id}")
    public StoryPart getStoryPartById(@PathVariable Long id) { return storyPartsService.findById(id);}
